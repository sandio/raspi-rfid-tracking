...
legend("topright", c("1 at 130cm","2 at 60cm","3 at 6cm"), pch=1:3, title="Readers")

plot(x1range, y2range, type="n", xlab="Distance (m)", ylab="RSSI (unitless)")
lines(x1, r11, type="b", pch=1)
lines(x1, r12, type="b", pch=2)
lines(x1, r13, type="b", pch=3)
title("Tag at 60cm above floor level")
legend("topright", c("1 at 130cm","2 at 60cm","3 at 6cm"), pch=1:3, title="Readers")

plot(x1range, y2range, type="n", xlab="Distance (m)", ylab="RSSI (unitless)")
lines(x1, r21, type="b", pch=1)
lines(x1, r22, type="b", pch=2)
lines(x1, r23, type="b", pch=3)
